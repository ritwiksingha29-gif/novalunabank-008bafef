...
export const Route = createFileRoute("/support")({
  head: () => ({ meta: [{ title: "Customer Support — Reflo Bank" }] }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="mx-auto max-w-7xl px-4 py-16">
          ...
          <p className="mt-2 opacity-90">Reach the Reflo Bank support team 24 hours a day, 7 days a week.</p>
        </div>
      </section>
      <section className="mx-auto max-w-5xl px-4 py-16 grid sm:grid-cols-2 gap-6">
        {[
          { icon: Phone, t: "Call Us", d: "1-800-REFLO-US (1-800-733-5687)" },
          { icon: Mail, t: "Email Support", d: "support@reflobank.com" },
